...
data = pd.read_csv("/../../../Data/CoNLL_2003/CoNLL_data/CoNLL_train.csv",encoding='unicode_escape')
...
for i in data.index:
    ...
    if len(str(data.at[i,"Sentence #"])) != 4:
...
data2.to_csv("Pegasus_augmentations_CoNLL.csv")